    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li> <a href="#" class="waves-effect active"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Thesis<span class="fa arrow"></span></span></a>
                       <ul class="nav nav-second-level">
                                    ...
                                    <div class="inbox-center">
                                            <?php  
                                                            ...
                                                            '<div class="alert alert-warning" >
                                                                 ...
                                                                 <strong>DELETED!! </strong><p> The Thesis Post has been successfully deleted.</p>
                                                            </div>'
                                                            ;
                                                        }
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Thesis Posts (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
