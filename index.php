    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="../plugins/images/icon.png" style="width: 30px; height: 30px;" alt="home" /></b><span class="hidden-xs"><b>TPPS</b></span></a></div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Thesis<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="posts.php">All Papers</a></li>
                            <li><a href="new-post.php">Create Paper</a></li>
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Messages</span></a>
                    ...
                    <li><a href="functions/livechat.php" class="waves-effect"><i class="icon-logout fa-fw"></i> <span class="hide-menu">Live Chat</span></a></li>
        ...
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">TPPS Thesis Posts</h5> </div>
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                            <h5 class="text-muted vb">Thesis Comments</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-3 col-sm-6  b-0">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe016;"></i>
                                            <h5 class="text-muted vb">TPPS Subscribers</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="row sales-report">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h2>Thesis and Project Proposal System 2023</h2>
                                    <p>Thesis Posts</p>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 ">
                                ...
                                <table class="table ">
                                    ...
                                    <?php
                                             if (mysqli_num_rows($query_posts)==0) {
                                                 echo "<i style='color:brown;'>No Posts Yet :( Upload TPPS's first thesis post today! </i> ";
                                                    }
                                                    else
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2023 &copy; Dill Afrose </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
